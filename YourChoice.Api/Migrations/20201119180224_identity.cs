...
namespace YourChoice.Api.Migrations
{
    public partial class identity : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.DropForeignKey(
                name: "FK_Subscription_Users_ToWhomId",
                table: "Subscription");

            migrationBuilder.DropForeignKey(
                name: "FK_Subscription_Users_WhoId",
                table: "Subscription");
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    RegistrationDate = table.Column<DateTime>(type: "datetime2", nullable: false, defaultValue: new DateTime(2020, 11, 19, 20, 2, 23, 152, DateTimeKind.Local).AddTicks(4938)),
            ...
            migrationBuilder.AddForeignKey(
                name: "FK_Subscription_AspNetUsers_ToWhomId",
                table: "Subscription",
                column: "ToWhomId",
                principalTable: "AspNetUsers",
                principalColumn: "Id",
            ...
            migrationBuilder.AddForeignKey(
                name: "FK_Subscription_AspNetUsers_WhoId",
                table: "Subscription",
                column: "WhoId",
                principalTable: "AspNetUsers",
                principalColumn: "Id",
        ...
        protected override void Down(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    RegistrationDate = table.Column<DateTime>(type: "datetime2", nullable: false, defaultValue: new DateTime(2020, 11, 14, 14, 47, 15, 384, DateTimeKind.Local).AddTicks(8460)),
                    Surname = table.Column<string>(type: "nvarchar(50)", maxLength: 50, nullable: true)
                },
                constraints: table =>
                {
